<template>
    <div class="">
      <MainLayout>
        <template #main>
          <section class="w-full overflow-hidden bg-[#EDCA70] text-white">
            <div class="flex justify-center text-white bg-[#EDCA70]">
              <h2 class="mb-6 text-3xl font-bold lg:text-5xl">🌿 ¿Quiénes Somos? 🌿</h2>
            </div>
  <p class="mb-4 text-lg font-medium font-poppins lg:text-2xl">Descubre nuestra esencia y compromiso con la salud a través de productos ayurvédicos de calidad. 🌱</p>
  
  <div class="brand-info">
    <h3 class="mb-4 text-2xl font-semibold text-orange-700 lg:text-4xl">Sobre nuestra marca 🌟</h3>
  ...
  <div class="mission">
    <h3 class="mb-4 text-2xl font-semibold text-orange-700 lg:text-4xl">Nuestra misión 🎯</h3>
  ...
  <div class="vision">
    <h3 class="mb-4 text-2xl font-semibold text-orange-700 lg:text-4xl">Nuestra visión 👀</h3>
  ...
  <div class="product-quality">
    <h3 class="mb-4 text-2xl font-semibold text-orange-700 lg:text-4xl">Calidad garantizada ✔️</h3>
    <ul class="pl-6 font-medium list-disc font-poppins">
      <li>100% Naturales 🍃</li>
  ...
  <div class="our-story">
    <h3 class="mb-4 text-2xl font-medium text-orange-700 lg:text-4xl">Nuestra historia 📖</h3>
  ...
  <div class="what-we-offer">
    <h3 class="mb-4 text-2xl font-medium text-orange-700 lg:text-4xl">¿Qué ofrecemos? 🛍️</h3>
  ...
  <div class="contact">
    <h3 class="mb-4 text-2xl font-medium text-orange-700 lg:text-4xl">Contacto rápido 📞</h3>
  ...
  <div class="secure-purchase">
    <h3 class="mb-4 text-2xl font-medium text-orange-700 lg:text-4xl">Compras seguras 💳</h3>
  ...
  <div class="exported-products">
    <h3 class="mb-4 text-2xl font-medium text-orange-700 lg:text-4xl">Productos exportados ✈️</h3>
  ...
  <div class="auxiliary-medicines">
    <h3 class="mb-4 text-2xl font-medium text-orange-700 lg:text-4xl">Medicinas auxiliares 💊</h3>
  ...
  <div class="product-variety">
    <h3 class="mb-4 text-2xl font-medium text-orange-700 lg:text-4xl">Variedad de productos 🌈</h3>
  ...
  <div class="flex justify-center gap-10 my-3 stats">
    <div><strong class="lg:text-2xl">+50</strong><p class="text-2xl font-medium font-poppin">Años de experiencia 🕰️</p></div>
    <div><strong class="lg:text-2xl">+1000</strong><p class="text-2xl font-medium font-poppin">Artículos vendidos 📦</p></div>
    <div><strong class="lg:text-2xl">100%</strong><p class="text-2xl font-medium font-poppin">Productos Naturales y Vegetarianos 🌿</p></div>
    <div><strong class="lg:text-2xl">100%</strong><p class="text-2xl font-medium font-poppin">Calidad Ayurvédica 🔅</p></div>
  </div>
</section>
